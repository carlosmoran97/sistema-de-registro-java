...
public class GestionarVenta extends javax.swing.JFrame {
    ...
    private DefaultTableModel lineasDeVenta;
    private String data[][] = {};
    ...
    public GestionarVenta() {
        initComponents();
        lineasDeVenta = new DefaultTableModel(data, cabecera);
        tablaLineasDeVenta.setModel(lineasDeVenta);
        activeWindows++;
    }
    ...
    private void initComponents() {
        ...
        btnIniciar.setText("Iniciar la venta");
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "Lineas de venta"));
        ...
        TabCompras.addTab("Agregar Venta", jPanel1);
        ...
        TabCompras.addTab("Registro de ventas", jPanel2);
    ...
    private void txtNitKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtNitKeyPressed
        ...
        if (evt.getKeyCode() == ENTER_CODE) {
            try {
                Cliente cliente = ClienteBd.obtenerClientePorNit(txtNit.getText());
                if (cliente != null) {
    ...
    private void btnIniciarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIniciarActionPerformed
        ...
        try {
            ...
            ventaActual.setFecha(Date.valueOf(txtFecha.getText()));
            ventaActual.setNumeroDeDocumento(txtNumeroDocumento.getText());
            ventaActual.setFinalizada(false);
            try {
                VentaBd.insertarVenta(ventaActual.getFecha(), ventaActual.getNumeroDeDocumento(), ventaActual.getCliente());
                ventaActual.setId(VentaBd.obtenerUltimaVenta().getId());
                habilitarControlesDatosDeDocumento(false);
                habilitarControlesLineasDeCompra(true);
                // LIMPIAR TABLE MODEL
            } catch (SQLException e) {
                JOptionPane.showMessageDialog(this, "Error al iniciar la venta." + e.getMessage(), "Algo ha salido mal", JOptionPane.ERROR_MESSAGE);
            }
    ...
    private void formWindowClosing(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosing
        // TODO add your handling code here:
        try {
            if (ventaActual.getId() != 0 && !ventaActual.isFinalizada()) {
                VentaBd.eliminarVenta(ventaActual.getId());
                JOptionPane.showMessageDialog(this, "La venta no se finalizó. Se eliminó del regitro.");
            }
        } catch (SQLException e) {
    ...
    private void btnFinalizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFinalizarActionPerformed
        // TODO add your handling code here:
        if (ventaActual.lineasDeVenta.size() > 0) {
            //INSERTAR LA VENTA Y LAS LÍNEAS DE VENTA
            try {
                for (LineaDeVenta ldv : ventaActual.lineasDeVenta) {
                    LineaDeVentaBd.insertarLineaDeVenta(ldv.getProducto(), ldv.getCantidad(), ldv.getPrecioUnitario(), ventaActual);
                }
                //LIMPIARLA Y DEJAR LISTO TODO PARA UNA NUEVA VENTA
            ...
            JOptionPane.showMessageDialog(this, "Debe ingresar al menos una línea de venta.", "Advertencia", JOptionPane.WARNING_MESSAGE);
        }
    }//GEN-LAST:event_btnFinalizarActionPerformed
    private void limpiarFormulario() {
        int rows = lineasDeVenta.getRowCount();
        txtCodigo.setText("");
        ...
        ventaActual.setFinalizada(true);
        ventaActual.setId(0);
        ventaActual.lineasDeVenta.clear();
        // LIMPIAR TABLE MODEL
        for (int i = 0; i < rows; i++) {
            lineasDeVenta.removeRow(0);
        }
        lineasDeVenta.fireTableDataChanged();
        tablaLineasDeVenta.repaint();
    }
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        ...
        try {
            ...
            if (ventaActual.validarLineaDeVenta(ldv)) {
                // AGREGAR A LA TABLA
                String[] data = {
                    String.valueOf(ldv.getCantidad()),
                    ldv.getProducto().getNombre(),
                    String.valueOf(ldv.getPrecioUnitario()),
                    String.valueOf(ldv.subtotal())
                };
                lineasDeVenta.addRow(data);
                tablaLineasDeVenta.repaint();
                txtTotal.setText(String.format("$ %.2f", ventaActual.total()));
            } else {
...
//COMENTADO POR MOLESTO ALV
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GestionarVenta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GestionarVenta().setVisible(true);
            }
        });
    }
